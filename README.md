...
| Observability    | None                  | ✅ Query logging + Analytics Dashboard |
...
| Query Logging    | SQLite (query_log.db)           |
...
**Sai Charan Goud K**
AI/ML Engineer | RAG · FAISS · FastAPI · LangChain · Groq
